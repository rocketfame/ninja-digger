...
async function getStats() {
  try {
    const [bpEmail, bpWork, raTotal, raEmail, raWork, sentToday, sentYesterday, sentTotal, bounced, touchStats, contacted, replied, won] = await Promise.all([
    ...
    return { bp: { email: 0, work: 0 }, ra: { total: 0, email: 0, work: 0 }, sent: { today: 0, yesterday: 0, total: 0 }, bounced: 0, funnel: EMPTY_FUNNEL };
  }
}
