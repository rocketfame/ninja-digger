...
2. Прочитай файли в knowledge/ — спершу `knowledge/SESSION-HANDOFF.md` (де зупинилися минулої сесії)
...
7. Сервери, dev, watch запускай тільки у фоні, ніколи не блокуючи сесію.
8. Тести запускай з одноразовим прогоном (`--run` / `--watch=false`).
