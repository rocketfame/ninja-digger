-- Новачки: «вперше залетіли» відносно вікна даних, а не CURRENT_DATE.
-- Якщо дані — бекфіл за 2 міс., ref_date = остання дата в chart_entries;
-- NEWCOMER = first_seen в останні 14 днів цього вікна (ref_date - 14 .. ref_date).
...
BEGIN
  ...
  SELECT
    ...
    CASE
      ...
      WHEN m.first_seen >= ref_date - 14 THEN 'NEWCOMER'
